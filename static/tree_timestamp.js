function draw_treeTimestamp(service,start_date,start_time,end_date,end_time,compare){
    console.log(service,start_date,start_time,end_date,end_time)
    console.log(service)
  ...
  var data = [{key:""}]
     ...
     d3.json("getData_fromTimestamp/"+service+"/"+start+"/"+end, function(error,treeData) {
    ...
    nodeEnter.append('rect')
      ...
      .style('fill', function(d) {
        ...
        timeout = setTimeout(function() {
          ...
          d3.json("/getPercOcc?string="+encodeURIComponent(node_path)+"&number="+start+"&number1="+end, function(error,perc_occ) {
            if (error) throw error;
      ...
      var x = d3.scaleLinear()
          ...
          .sort(function(a, b) {
            a = a.key.replace('[','').replace(']','')
            b = (b.key).replace('[','').replace(']','')
      ...
      svg.selectAll(".bar")
        ...
        .enter().append("rect")
          ...
          .on("click", function(d) {
            ...
            x=d.key
            double_hist(node_path,service,x,compare,start,end)
        });
